...
math_validate_method_contract
  -> Postgres-backed source/chunk/embedding/index state, ingestion reports, hybrid retrieved refs, dereferenced chunk text, citation validation, and method metadata
