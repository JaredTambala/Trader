...
```bash
uv run pytest tests/test_research_contracts.py tests/test_tool_contracts.py tests/test_research.py tests/test_research_tools.py tests/test_research_domain.py tests/test_quant_research_supervisor.py tests/test_supervisor_data_handoff.py tests/test_langgraph_data_workflow.py tests/test_mcp_data_workflow.py tests/test_mcp_first_tool_evidence.py tests/test_mcp_tools.py tests/test_mcp_server.py tests/test_agent_identities.py tests/test_mcp_adapters.py tests/test_sql_boundaries.py tests/test_package_boundaries.py tests/test_sprint5_cli.py
uv run ruff check src/trader_research src/trader_mcp src/trader_agents src/trader/research.py src/trader/tools run_compare_results.py run_research_recommendations.py run_research_discovery.py run_prepare_paper_promotion.py run_research_experiment.py run_data_quality.py run_market_data_backfill.py tests/test_research_contracts.py tests/test_tool_contracts.py tests/test_research.py tests/test_research_tools.py tests/test_research_domain.py tests/test_quant_research_supervisor.py tests/test_supervisor_data_handoff.py tests/test_langgraph_data_workflow.py tests/test_mcp_data_workflow.py tests/test_mcp_first_tool_evidence.py tests/test_mcp_tools.py tests/test_mcp_server.py tests/test_agent_identities.py tests/test_mcp_adapters.py tests/test_sql_boundaries.py tests/test_package_boundaries.py tests/test_sprint5_cli.py tests/support
