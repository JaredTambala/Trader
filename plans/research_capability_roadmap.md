...
3. Implement the selected LangGraph runtime foundation, model/program/catalog identities, dynamic role policy,
   checkpoint/interrupt boundary, and redacted trace correlation.
4. Implement the Data Research, Strategy Engineering, and Coordinator loops over that foundation.
5. Qualify the production slice across the frozen 12-scenario dataset before extending into Experiment
