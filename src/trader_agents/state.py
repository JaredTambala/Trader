...
class DataAgentState(TypedDict, total=False):
    ...
    Attributes:
        ...
        symbol_discovery_request: JSON-native request passed to `data_discover_symbols`.
        ...
        user_request: Natural-language user request used by an LLM policy graph.
        llm_decisions: Sanitized Data Agent LLM policy decisions emitted during a run.
        next_policy_route: Next graph route selected by the Data Agent policy router.
        ...
        symbol_discovery_report: Symbol discovery report from the mandatory preflight.
        ...
        blockers: Structured graph blockers.
    ...
    symbol_discovery_report: dict[str, Any]
...
def build_data_agent_initial_state(
    *,
    ...
    symbol_discovery_source: str = "configured_source",
    ...
    Args:
        ...
        provider: Optional requested provider selector.
        instrument_type: Optional provider-scoped instrument type.
        bar_type: Optional provider-scoped bar type.
        user_request: Optional natural-language request for an LLM policy graph.
        symbol_discovery_source: Source mode used by the mandatory symbol preflight.
    ...
    symbol_discovery_request = {
        ...
        "provider": provider,
        "timeframe": timeframe,
        "source": symbol_discovery_source,
        "source_filter": source,
        "limit": max(50, len(symbols)),
        "include_local_coverage": False,
    }
    symbol_discovery_request = {key: value for key, value in symbol_discovery_request.items() if value is not None}
    ...
    return {
        ...
        "symbol_discovery_request": symbol_discovery_request,
