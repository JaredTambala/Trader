...
from trader_mcp.contracts import SideEffect, side_effect_for_operation
from trader_research.foundation import json_payload_hash

from .contracts import AgentPhase, AgentRole
...
class ToolCatalogue:
    ...
    def __init__(self, definitions: Iterable[ToolDefinition]) -> None:
        ...
        by_role_and_name = {
            (definition.role, definition.name): definition
        ...
        for definition in self._definitions:
            ...
            if definition.approval_key is not None:
                if not _approval_granted(
                    approval_policy.get(definition.approval_key)
                ):
                    continue
