...
from .market_data_queries import BarQuery, fetch_bar_timestamps, normalize_bar_query
...
@dataclass(frozen=True)
class GapRecord:
    """Gap detected by the legacy data-quality report path."""
...
class DataQualitySummary:
    """Legacy data-quality summary for one symbol."""
...
@dataclass(frozen=True)
class SessionWindow:
    """Configured market session window for gap classification."""
