...
from .market_data import CryptoBarEvent, MarketDataSource, StockBarEvent
...
class AlpacaRequestSpec:
    """Container for Alpaca request configuration."""
...
class AlpacaMarketDataSource(MarketDataSource):
    """Polling market data source using alpaca-py historical data clients."""
