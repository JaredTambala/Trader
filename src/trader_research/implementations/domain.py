...
from trader_research.artifact_store import source_hash
from trader_research.contracts import SCHEMA_VERSION
from trader_research.domain import IMPLEMENTATION_VERSION, stable_research_id
...
RUNTIME_CONTRACT_BY_KIND = {
    ...
    "optimization_objective": "trader_research.optimization.OptimizationObjective",
}
