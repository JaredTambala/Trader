...
from trader_research.artifact_store import ResearchArtifactStore, json_payload_hash, load_artifact_ref
...
def specification_error(command: str, code: str, message: str) -> ToolEnvelope:
