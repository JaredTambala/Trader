...
Subject: Separation of checkpoint, product, operator, model, and frozen-code identities.
Level: Cross-package controlled qualification.
Collaborators: Real guarded Postgres roles, served local model metadata, and repository source paths.
Guarantees: Checkpoint credentials are least-privilege and runtime identity matches the approved freeze.
Non-goals: Scenario behavior, MCP execution, recovery, or final acceptance.
"""
