"""Postgres evidence records for bounded optimization scale qualification.

The helpers persist and reload local scale measurements without turning those
measurements into product service-level objectives.
"""
