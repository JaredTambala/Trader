"""Deterministic multi-asset fixture for cross-package optimization qualification.

The fixture owns stable selection/holdout rows, admitted implementation source,
and expected hashes shared by direct-service and MCP evidence graphs.
"""
