...
Subject: Behavioral qualification of every approved Coordinator/Data/Strategy scenario repetition.
Level: Cross-package controlled qualification.
Collaborators: Real local model, MCP processes, guarded Postgres fixtures, and canonical result storage.
Guarantees: All 36 frozen scenario runs persist, reload, and satisfy the evaluation charter.
Non-goals: Training models, widening agent authority, deployment, or live trading.
"""
