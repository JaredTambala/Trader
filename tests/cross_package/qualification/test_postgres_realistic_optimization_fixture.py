"""Realistic deterministic fixture and direct Postgres optimization qualification.

Subject: Multi-symbol selection and holdout data driving admitted strategy, risk, backtest, and optimization evidence.
Level: Cross-package deterministic fixture contract plus controlled Postgres qualification.
Collaborators: Core event storage, research admission/backtest/optimization services, and typed projections.
Guarantees: The fixture is bounded and repeatable, and its full direct-service evidence remains meaningful.
Non-goals: MCP transport, optional optimizer providers, model reasoning, or live market data.
"""
...
def test_realistic_optimization_fixture_is_bounded_and_deterministic() -> None:
    """Prove the realistic selection and holdout fixture is bounded and repeatable."""
...
def test_postgres_realistic_strategy_risk_backtest_and_optimization_evidence(
    ...
    """Prove the realistic fixture yields canonical direct-service optimization evidence."""
