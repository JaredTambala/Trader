"""Verify that a built Trader wheel contains every package-owned document.

This script is documentation-test infrastructure and operates only on the wheel
path supplied by the caller; it does not build or install distributions.
"""
