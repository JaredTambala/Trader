...
Subject: Deterministic execution of the distribution's selected learning notebooks.
Level: Cross-package documentation integration contract.
Collaborators: Real nbclient kernels and temporary notebook copies; no network or external service.
Guarantees: Every selected notebook executes without errors and leaves its shipped copy unchanged.
Non-goals: Notebook output presentation, performance benchmarking, or live provider workflows.
"""
