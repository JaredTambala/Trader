"""Contracts tying Postgres SQL statement shapes to event-store records.

Subject: Placeholder counts and selected fields for lifecycle and experiment SQL statements.
Level: Static persistence-contract unit tests.
Collaborators: Real statement constants and the canonical experiment-run field declaration.
Guarantees: SQL parameter arity and query projections stay aligned with adapter normalization contracts.
Non-goals: SQL execution, schema correctness, query planning, transaction isolation, or performance.
"""
