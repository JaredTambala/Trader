"""Contracts for optional filtering around an event-store adapter.

Subject: Immutable event allowlists, generic-event filtering, and lifecycle-write delegation.
Level: Deterministic adapter unit contracts.
Collaborators: The real filtered adapter, filter-policy builder, and an in-memory recording store.
Guarantees: Only configured generic events are filtered while mandatory lifecycle evidence is delegated.
Non-goals: Persistence backends, buffering, schema behavior, or runtime configuration parsing.
"""
