"""Deterministic public trajectory observation for Agent qualification.

The observer reconstructs bounded, redacted lifecycle evidence across console,
checkpoint, and MLflow sources without treating telemetry as canonical state.
"""
...
from trader_mcp.protocol.contracts import SideEffect
from trader_research.governance import ResearchSession

from trader_agents.mcp.catalogue import ToolDefinition, first_slice_tool_catalogue
from trader_agents.contracts.domain import AgentRole, BudgetUsage
from trader_agents.contracts.inputs import composite_data_scope_from_session
...
from tests.trader_agents.contracts_state.support.agentic_scenarios import load_agentic_scenario_inputs
