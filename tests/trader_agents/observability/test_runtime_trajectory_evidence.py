"""Tests for interpreting public agent runtime trajectories as evidence.

Subject: Agent-owned normalization and deterministic assessment of public runtime state, spans, and journals.
Level: Unit and local-adapter integration.
Collaborators: Real observation helpers and contracts, synthetic public trajectories, and a real local MLflow store.
Guarantees: Qualification evidence detects lineage violations, counts lost work, rejects unsafe spans, and loads exact traces.
Non-goals: Running the agent graph, judging model quality, exercising MCP or Postgres, and release acceptance.
"""
...
from tests.trader_agents.application_runtime.support.agentic_assessment import assess_agentic_scenario
from tests.trader_agents.observability.support.agentic_observation import (
    LifecycleTrace,
    PublicTraceSpan,
...
from trader_agents.observability.tracing import MlflowTraceSink
