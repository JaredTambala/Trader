"""Contract tests for Agent qualification session inputs.

Subject: Agent contract/state normalization of versioned qualification session inputs.
Level: In-process contract.
Collaborators: Real Agent contracts and deterministic shared fixture loaders; no external service.
Guarantees: Scenario coverage, strict pins, identity isolation, and invalid campaign inputs remain enforced.
Non-goals: Running model-backed agents, executing MCP tools, or qualifying scenario outcomes.
"""
