"""Strict concrete session fixtures for Agent contract qualification.

The builders translate versioned JSON inputs into immutable session, scope,
authority, and budget values shared by Agent contract and qualification tests.
"""
