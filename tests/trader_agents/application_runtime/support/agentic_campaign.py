...
The runner owns fresh-process lifecycle execution, recovery accounting, and
complete campaign result capture for the Agent application runtime.
"""
...
from tests.trader_agents.application_runtime.support.agentic_session_worker import (
    FAULT_EXIT_CODE,
    FAULT_RESULT_PREFIX,
    STATE_RESULT_PREFIX,
)
...
_SESSION_WORKER_MODULE = "tests.trader_agents.application_runtime.support.agentic_session_worker"
