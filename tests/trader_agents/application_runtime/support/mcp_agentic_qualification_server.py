"""Guarded stdio MCP composition for Agent application qualification.

This subprocess fixture wires the controlled research dependencies required by
the Agent runtime while retaining the production MCP transport boundary.
"""
