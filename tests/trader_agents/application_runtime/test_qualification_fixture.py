"""Workflow contracts for deterministic Agent qualification fixtures.

Subject: Application-owned Data and implementation states used by the controlled behavioral scenarios.
Level: Local fixture integration.
Collaborators: Real DuckDB, research Data, catalogue, validation, and in-memory artifact services; no network.
Guarantees: Ready, gapped, unfit, reusable, adaptable, failed, and admitted states have real reproducible evidence.
Non-goals: Agent graph execution, model choice, PostgreSQL, container isolation, and campaign scoring.
"""
...
from tests.trader_agents.application_runtime.support.agentic_fixture import (
...
from trader_agents.contracts.inputs import (
