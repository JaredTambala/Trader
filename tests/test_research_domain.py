...
def test_planned_artifact_reference_types_are_json_safe() -> None:
    refs = [
        ...
        artifact_report_ref(IMPLEMENTATION_VALIDATION_REPORT, "implementation_validation_demo"),
        artifact_report_ref(STRATEGY_SPECIFICATION, "strategy_specification_demo"),
        artifact_report_ref(STRATEGY_SPECIFICATION_VALIDATION_REPORT, "strategy_specification_validation_demo"),
        ...
        artifact_report_ref(BACKTEST_SPECIFICATION_VALIDATION_REPORT, "backtest_validation_demo"),
        ...
        artifact_report_ref(EXPERIMENT_TRACKING_PROJECTION_REPORT, "tracking_projection_demo"),
        artifact_report_ref(PARAMETER_OPTIMIZATION_EVALUATION_REPORT, "optimization_evaluation_demo"),
        artifact_report_ref(PARAMETER_OPTIMIZATION_AUDIT_PLAN, "optimization_audit_plan_demo"),
        artifact_report_ref(PARAMETER_OPTIMIZATION_ROBUSTNESS_REPORT, "optimization_robustness_demo"),
    ...
    assert owner_by_type[PARAMETER_OPTIMIZATION_ROBUSTNESS_REPORT] == "Adversarial Agent"
    json.dumps(payload)
