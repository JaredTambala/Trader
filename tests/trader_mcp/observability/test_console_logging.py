"""Contract tests for protocol-safe MCP subprocess console logging.

Subject: MCP process logging configuration, rendering, correlation, and field safety.
Level: Unit contract.
Collaborators: Real logger and in-memory text streams; no subprocess or protocol stdout.
Guarantees: INFO/DEBUG output is bounded, labelled, parseable, and secret resistant.
Non-goals: Agent telemetry, database persistence, stdio framing, or log aggregation.
"""
...
from trader_mcp.observability.console import (
    McpConsoleConfig,
    McpConsoleLogger,
    McpLogFormat,
    McpLogLevel,
