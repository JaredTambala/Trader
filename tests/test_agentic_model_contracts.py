"""Focused real-model choice contracts for the first agentic slice."""
...
from trader_agents.coordinator import _propose_coordinator_agenda
from trader_agents.llm_client import build_llm_client_from_env
...
def test_coordinator_model_selects_only_data_for_readiness_briefs() -> None:
    ...
    for agenda in agendas:
        ...
        assert {task.role for task in agenda.tasks} == {
