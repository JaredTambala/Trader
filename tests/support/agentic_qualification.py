"""Contracts and persistence helpers for first-slice agentic qualification."""
...
from trader_agents.profiles import DEVELOPMENT_MODEL_PROFILE_ID
from trader_agents.runtime import runtime_manifest
...
AGENTIC_EVALUATION_FIXTURE = (
    REPOSITORY_ROOT / "tests" / "fixtures" / "agentic_slice_scenarios.json"
)
AGENTIC_SESSION_INPUT_FIXTURE = (
    REPOSITORY_ROOT / "tests" / "fixtures" / "agentic_slice_session_inputs.json"
)
