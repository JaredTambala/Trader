"""Unit tests for PostgresEventStore adapter method wiring."""
...
def test_record_event_uses_insert_plan_and_aligned_values(
    ...
    def fake_event_insert_query(plan: object) -> object:
        event_plan = plan  # local name keeps assertions readable inside tuple construction.
        return (
            "insert",
...
def test_record_run_session_start_uses_normalized_statement_parameters() -> None:
    """Ensure lifecycle shell methods delegate parameter normalization."""
