...
from trader_research.methodology import math_list_method_contracts, math_validate_method_contract
...
def test_math_validate_method_contract_checks_parameters_and_evidence(tmp_path: Path) -> None:
    ...
    store.save_method_card(
        MethodCard(
            ...
            validation_refs=({"artifact_type": "methodology_candidate_validation_report", "artifact_id": "validation_rank_ic_test"},),
        )
    )
