"""Task 57O Postgres restart, resume, and fault-injection qualification."""
...
from tests.support.postgres_57n import reset_57n_product_state
...
def _run_worker(plan_ref: str, *, max_new_trials: int | None = None) -> Mapping[str, Any]:
    command = [
        sys.executable,
        "-m",
        "tests.support.postgres_optimization_resume_worker",
        "--plan-ref",
        plan_ref,
    ]
