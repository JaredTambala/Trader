"""Adapter-integration tests for Postgres orchestration projections.

Subject: Governance-owned objectives, protocols, workflow plans, proposals, and outcomes in Postgres.
Level: Adapter integration with one offline schema contract.
Collaborators: Real schema declarations and guarded Postgres; no coordinator, MCP transport, or model.
Guarantees: Canonical orchestration artifacts retain typed fields and authority provenance after persistence.
Non-goals: Executing plans, validating research quality, testing recovery, or qualifying an agent campaign.
"""
...
def test_research_schema_exposes_orchestration_records_to_pgadmin() -> None:
    """The offline schema declares tables for every canonical orchestration record family."""
...
def test_orchestration_artifacts_have_typed_postgres_projections(
    ...
    """Persisted orchestration records retain typed relationships, status, and authority provenance in Postgres."""
