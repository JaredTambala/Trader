"""Adapter-integration test for fresh-connection Data mutation recovery.

Subject: Durable prepared and terminal loading evidence across independent Postgres store connections.
Level: Adapter integration.
Collaborators: Real guarded Postgres artifact store, shared DuckDB, sample CSV, and injected loader.
Guarantees: A lost terminal write is reconciled without repeating accepted provider work.
Non-goals: Agent reasoning, MCP transport, real provider access, concurrent recovery, or database qualification.
"""
