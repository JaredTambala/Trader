"""Focused contracts for Strategy Engineering implementation discovery."""
...
def test_catalogue_separates_maintained_metadata_from_admitted_reuse() -> None:
    ...
    assert admitted["implementation_version_id"] == implementation.implementation_version_id
...
def test_exact_resolution_reveals_source_only_when_requested() -> None:
    ...
    assert authorized.data["implementation"]["source_code"] == implementation.source_code
