# Semantic Methodology Extraction
...
[tool_contracts.md](tool_contracts.md); registered tool metadata remains in [mcp_tools.md](mcp_tools.md); runtime setup
and recovery remain in [operations.md](operations.md). Strategy generation and backtesting are downstream consumers and
are outside this document.

## Delivery Status

The implemented subsystem is pinned at the 33AB baseline. Full-document ingestion, evidence units, embeddings,
