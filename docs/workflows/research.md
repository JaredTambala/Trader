...
[Product State](../product_state.md#agent-state) and the
...
validation process are defined in [Knowledge Ingestion And Semantic Methodology Extraction](../../src/trader_research/docs/knowledge.md).
